...
public class UserServiceIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        userRepository.deleteAll(); // 테스트 전 데이터를 초기화
    }
    ...
    void createUser_Success() {
        ...
        // when
        Long userId = userService.createUser("joyuri@gmail.com", "yuri123");
    ...
    void createUser_AlreadyExistedUser_Then_Exception() {
        ...
        // when & then
        assertThatThrownBy(() -> userService.createUser("joyuri@gmail.com", "yuri123"))
...
public class UserServiceIntegrationTest {
    ...
    private WireMockServer wireMockServer; // Stub
    ...
    void valid() {
        ...
        // when
        boolean isValidated = userService.registerCard("3L", "123456789";)
    ...
    void timeout() {
        ...
        // when & then
        assertThatThrownBy(() -> userService.registerCard("3L", "123456789"))
            .isInstanceOf(ExpectedException.class)
            .satisfies(e -> {
