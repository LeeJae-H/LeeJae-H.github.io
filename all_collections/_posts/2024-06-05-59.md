...
- (SpringServletContainerInitializer 관련 참고)
    ...
    - org.springframework.spring-web 라이브러리를 보면, spring-web 모듈 jar가 있다.
        - spring-web 모듈의 /META-INF/services 경로에 jakarta.servlet.ServletContainerInitializer 파일이 있고, SpringServletContainerInitializer 클래스가 적혀있다.
        - spring-web 모듈의 /org/springframework/web 경로에 SpringServletContainerInitializer 클래스와 WebApplicationInitializer 인터페이스가 있다.  
